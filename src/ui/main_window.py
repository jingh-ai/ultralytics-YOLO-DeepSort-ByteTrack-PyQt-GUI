...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_model.setItemText(0, _translate("MainWindow", "YOLO11n"))
        self.comboBox_model.setItemText(1, _translate("MainWindow", "YOLO11s"))
        self.comboBox_model.setItemText(2, _translate("MainWindow", "YOLO11m"))
        self.comboBox_model.setItemText(3, _translate("MainWindow", "YOLO11l"))
        self.comboBox_model.setItemText(4, _translate("MainWindow", "YOLO11x"))
        self.comboBox_model.setItemText(5, _translate("MainWindow", "YOLOv8n"))
        self.comboBox_model.setItemText(6, _translate("MainWindow", "YOLOv8s"))
        self.comboBox_model.setItemText(7, _translate("MainWindow", "YOLOv8m"))
        self.comboBox_model.setItemText(8, _translate("MainWindow", "YOLOv8l"))
        self.comboBox_model.setItemText(9, _translate("MainWindow", "YOLOv8x"))
