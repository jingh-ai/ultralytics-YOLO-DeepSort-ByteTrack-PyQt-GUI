...
"}\n"
"")
        self.comboBox_model.setCurrentText("YOLO11n")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ultralytics YOLO GUI"))
        ...
        self.comboBox_model.setItemText(0, _translate("MainWindow", "YOLO26n"))
        self.comboBox_model.setItemText(1, _translate("MainWindow", "YOLO26s"))
        self.comboBox_model.setItemText(2, _translate("MainWindow", "YOLO26l"))
        self.comboBox_model.setItemText(3, _translate("MainWindow", "YOLO26x"))
        self.comboBox_model.setItemText(4, _translate("MainWindow", "YOLOv13n"))
        self.comboBox_model.setItemText(5, _translate("MainWindow", "YOLOv13s"))
        self.comboBox_model.setItemText(6, _translate("MainWindow", "YOLOv13m"))
        self.comboBox_model.setItemText(7, _translate("MainWindow", "YOLOv13l"))
        self.comboBox_model.setItemText(8, _translate("MainWindow", "YOLOv13x"))
        self.comboBox_model.setItemText(9, _translate("MainWindow", "YOLO11n"))
        self.comboBox_model.setItemText(10, _translate("MainWindow", "YOLO11s"))
        self.comboBox_model.setItemText(11, _translate("MainWindow", "YOLO11m"))
        self.comboBox_model.setItemText(12, _translate("MainWindow", "YOLO11l"))
        self.comboBox_model.setItemText(13, _translate("MainWindow", "YOLO11x"))
